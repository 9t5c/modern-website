...
<template>
  <Motion
    ...
    :in-view="fadeIn.inView('', index * 0.5, 0.75)"
    tag="div"
    :class="
    ...
    <template v-else>
      ...
      >
        <div
          ...
          class="w-[60px] h-[60px] rounded-[24px] glassmorphism mb-[16px]"
        >
          <img
            src="/headset.svg"
            alt="headset"
        ...
        <p
          class="font-normal text-[16px] leading-[20.16px] text-white uppercase"
        >
          Enter Metaverse
        </p>
        <h2
          class="mt-[24px] font-semibold sm:text-[32px] text-[24px] text-white"
        >
          {{ title }}
        </h2>
      </div>
